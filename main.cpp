...
void game_start(const string sceneBreak, int &ClaudiusRep);
void print_stats(const int CArmySize, const int CRep);
void main_game_loop(const string sceneBreak, int &ClaudiusRep, char &choice, GameState &state);
...
int main() {
    ...
    game_start(sceneBreak, ClaudiusRep);

    do {
        main_game_loop(sceneBreak, ClaudiusRep, choice, state);
...
void main_game_loop(const string sceneBreak, int &ClaudiusRep, char &choice, GameState &state) {
    static Location ClaudiusLoc {Gaul};

    static int ClaudiusArmySize {10000};
    static int SeverusArmySize {12000};

    static int DanubeLegions {5000};
    static int BritishLegions {5000};

    static int BarbariansInvaded {0};
